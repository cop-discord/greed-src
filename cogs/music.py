...
class Player(pomice.Player):
    ...
    async def insert(self, track: pomice.Track) -> pomice.Track:
        try:
            await self.queue.put(track)
        except pomice.QueueFull:
            return None
        return track
    ...
    def set_context(self, ctx: GreedContext):
        self.context = ctx
...
class Music(Cog):
    ...
    async def music_send(self, ctx: GreedContext, message: str) -> Message:
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def stop(self, ctx: GreedContext):
    ...
    @is_voice()
    @bot_is_voice()
    async def shuffle(self, ctx: GreedContext):
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def queue(self, ctx: GreedContext):
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def resume(self, ctx: GreedContext):
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def pause(self, ctx: GreedContext):
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def skip(self, ctx: GreedContext):
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def volume(self, ctx: GreedContext, volume: why did he make a converter bro
        """
    ...
    @is_voice()
    @bot_is_voice()
    async def loop(self, ctx: GreedContext):
        """
    ...
    @command(aliases=["p"])
    @is_voice()
    async def play(self, ctx: GreedContext, *, query: str):
        """
