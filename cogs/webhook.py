...
class Webhooks(Cog):
    ...
    async def webhook_create(
        self, ctx: GreedContext, channel: discord.TextChannel, *, name: str = None
    ):
        """
        ...
        webhook = await channel.create_webhook(
            name="greed - webhook", reason=f"Webhook created by {ctx.author}"
        )
    ...
    async def webhook_edit(self, ctx: GreedContext):
        """
    ...
    async def webhook_edit_name(
        self, ctx: GreedContext, code: ValidWebhookCode, *, name: str
    ):
        """
    ...
    async def webhook_edit_avatar(
        self, ctx: GreedContext, code: ValidWebhookCode, url: str = None
    ):
        """
    ...
    async def webhook_send(
        self, ctx: GreedContext, code: ValidWebhookCode, *, script: EmbedScript = None
    ):
        """
    ...
    async def webhook_list(self, ctx: GreedContext):
        """
    ...
    @has_guild_permissions(manage_webhooks=True)
    @bot_has_guild_permissions(manage_webhooks=True)
    async def webhook_delete(self, ctx: GreedContext, code: ValidWebhookCode):
        """
