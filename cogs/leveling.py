...
class Leveling(Cog):
    ...
    @hybrid_command()
    @leveling_enabled()
    async def rank(self, ctx: GreedContext, *, member: Member = Author):
        """
    ...
    @leveling_enabled()
    async def level_test(self, ctx: GreedContext):
        """
        ...
        await channel.send(**x)
        return await ctx.message.add_reaction("<:cat_thumbsup:1216864927801802752>")

    @level_cmd.command(name="enable", brief="manage guild")
    @has_guild_permissions(manage_guild=True)
    async def level_enable(self, ctx: GreedContext):
        """
    ...
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    async def level_disable(self, ctx: GreedContext):
        """
    ...
    async def level_variables(self, ctx: GreedContext):
        """
    ...
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    async def booster_multiplier_enable(self, ctx: GreedContext):
        """
    ...
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    async def booster_multiplier_disable(self, ctx: GreedContext):
        """
    ...
    @leveling_enabled()
    async def level_config(self, ctx: GreedContext):
        """
    ...
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    async def level_set(self, ctx: GreedContext, level: int, *, member: LevelMember):
        """
    ...
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    async def level_reset(self, ctx: GreedContext, *, member: Member = None):
        """
    ...
    @leveling_enabled()
    async def level_leaderboard(self, ctx: GreedContext):
        """
    ...
    async def level_rewards_add(
        self, ctx: GreedContext, level: int, *, role: NewRoleConverter
    ):
    ...
    @has_guild_permissions(manage_guild=True)
    async def level_rewards_remove(self, ctx: GreedContext, *, role: NewRoleConverter):
    ...
    @has_guild_permissions(manage_guild=True)
    async def level_rewards_reset(self, ctx: GreedContext):
    ...
    async def level_rewards_list(self, ctx: GreedContext):
