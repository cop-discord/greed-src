...
class Donate(View):
    def __init__(self):
        ...
        self.responses = {
            "paypal": "https://paypal.me/sentontop",
            "bitcoin": "`bc1q2kgwepn9w86798vukj5htcxruj34kwfhu8j62z`",
            "litecoin": "`LPybRQ6ACT2B7aurLwVaHfEmizjhexbfkb`",
        }
    ...
    @button(emoji="<a:paypal:1123193320785584289>", custom_id="paypal")
    ...
    @button(emoji="<a:bitcoin:1123193865696989214>", custom_id="bitcoin")
    async def bitcoin_payment(self, interaction: Interaction, button: Button):
        await self.button_callback(interaction=interaction, button=button)

    @button(emoji="<:litecoin:1123194634030555166>", custom_id="litecoin")
    async def litecoin_payment(self, interaction: Interaction, button: Button):
        await self.button_callback(interaction=interaction, button=button)

    @button(emoji="<a:cashapp:1103320181343780924>", custom_id="cashapp")
